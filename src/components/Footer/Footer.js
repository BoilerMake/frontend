    ...
    <div className="p-footer__content">
      <div className="col-3">
        ...
        <ul className="p-footer__section_list">
          {
            socialLinks.map(link => <li className="p-footer__section_list_item"><a href={link.link}>{link.label}</a></li>)
          }
        </ul>
      </div>
      <div className="col-3">
        ...
        <ul className="p-footer__section_list">
          {
            pageLinks.map(link => <li className="p-footer__section_list_item"><Link to={link.link}>{link.label}</Link></li>)
          }
        </ul>
      </div>
    </div>
