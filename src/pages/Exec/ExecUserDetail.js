                    ...
                    <Grid.Row>
                        <Grid.Column>
                            <Header as='h3' dividing>Basic Info</Header>
                            {
                                ...
                                ? <Link to={"/exec/applications/"+userDetail.application_id}><Button>View Application (#{userDetail.application_id})</Button></Link>
                                : <Button disabled>User has no Application!</Button>
                            }
                            <List>
                                <List.Item><List.Header>First Name</List.Header>{userDetail.first_name || 'n/a'}</List.Item>
...
export default connect(mapStateToProps, mapDispatchToProps)(ExecUserDetail);
