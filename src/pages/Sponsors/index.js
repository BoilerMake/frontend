...
import './_pillar.sponsors.source.scss';
...
const Sponsors = () => (
  <div>
    ...
    <div className="p-sponsors">
      <div className="max-width home flex">
        <div className="col-8 paddingr" style={{ margin: '0 auto' }}>
          <h2>Foster a community of ideas</h2>
          <p>
            We would like to extend the opportunity for your company to be an
            essential part of the BoilerMake experience. Sponsors get access to
            a driven community of 500 highly motivated university students with
            new ideas that could be a beneficial part of your workplace. You’ll
            be able to tap this pool of talent to find qualified job and
            internship candidates and see them work as a team in a real-world
            setting. Interacting with students during the hackathon also allows
            you to promote your company’s new technologies to be used and
            explored.
          </p>
        </div>
      </div>
      <div className="middleBreak light">
        <div className="max-width home">
          ...
          <div className="p-sponsors__logos flex v-center h-center">
      ...
      <div className="max-width home flex" style={{ marginBottom: '50px' }}>
        <div className="col-8 paddingr" style={{ margin: '0 auto' }}>
          ...
          <ul>
            <li>
              Gaining access to hackers’ resumes, emails, GitHubs, and LinkedIn
              profiles
            </li>
            ...
            <li>
              Reserving space for private events with hackers (tech talks,
              mentorship sessions, etc.)
            </li>
          </ul>
          <br />
