						...
						<div className="col-6 messages">
							<Card>
								<div className="messages-inner text-reset">
									<Card>
										<p>One hour left to submit your projects! Make sure you get them in!</p>
										<i>Posted 11 mins ago</i>
									</Card>
									<Card>
										<p>Lunch will be available in Gyms 4, 5, and 6 in 10 minutes! But this one's a bit longer so watch out for that</p>
									...
									<Card>
										<p>Lunch will be available in Gyms 4, 5, and 6 in 10 minutes!</p>
										<i>Posted 56 mins ago</i>
									</Card>
									<Card>
										<p>One hour left to submit your projects! Make sure you get them in!</p>
