    ...
    {bm6 ? null : (
      <div className="max-width home flex">
        <div className="col-8 paddingr" style={{ margin: '30px auto' }}>
          ...
          <p>
            For the past five years, we've brought in 500 students from across
            the the country to create and collaborate on amazing ideas. This is
            an event for people who live and love hacking. Everything we do at
    ...
    {bm6 ? null : (
      <div className="max-width home" style={{ margin: '80px auto' }}>
        <div className="col-8" style={{ margin: '0 auto' }}>
          <h2>So what else?</h2>
          <p>
            BoilerMake offers a number of perks to make an amazing weekend. To
            get the weekend started, we provide busses to a number of schools to
            make travelling a no-brainer. In the past, we’ve sent buses to UIUC,
            UMich, and others.
          </p>
          <p>
            When you arrive, you will be given a swag bag that usually includes
            a t-shirt, a water bottle, and stickers. Each year we have some
            special swag. BoilerMake 5 saw a fidget spinner. BoilerMake 2 saw a
            custom designed dev board.
          </p>
          <p>
          ...
          <p>
            At the end we have an awards ceremony where over $10,000 in prizes
            are given out. Last year winning teams received DJI Phantoms or
            Nintendo Switches. In addition to BoilerMake prizes, sponsors also
            usually have prizes for their categories.
          </p>
        </div>
      </div>
    )}
